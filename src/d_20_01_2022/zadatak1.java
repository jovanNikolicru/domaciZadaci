...
*/
/*		Igrac i1= new Igrac("Mika Mikic", "4213494112339", 1990, 9, "napadac", false);
		Igrac i2 = new Igrac("Pera Peric", "412412412412", 1989, 10, "vezni", true);
		Trener t1= new Trener("Zika ZIkic", "1434214141541", 1961, 30, "kondicioni");
		Trener t2=new Trener("Mile MIlic", "4432421441", 1953,55, "glavni");
		i1.print();
		i2.print();
		t1.print();
		t2.print();*/
	...
	Scanner s = new Scanner(System.in);
		...
		ArrayList<Igrac>igraci=new ArrayList<Igrac>();
			...
			System.out.println("Ime i prezime, jmbg, godinu rodjenja, broj dresa, poziciju, da li je kapiten true/false");
